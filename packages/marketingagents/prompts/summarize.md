...
- `--window-size <chars>` or `MARKETINGAGENTS_SUMMARIZE_WINDOW_CHARS` (default: `6000`)
- `--overlap <chars>` or `MARKETINGAGENTS_SUMMARIZE_OVERLAP_CHARS` (default: `500`)
- `--tier1-threshold <chars>` or `MARKETINGAGENTS_SUMMARIZE_TIER1_THRESHOLD` (default: `8000`)
- `--tier2-threshold <chars>` or `MARKETINGAGENTS_SUMMARIZE_TIER2_THRESHOLD` (default: `60000`)
