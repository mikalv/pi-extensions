# Contributing to MarketingAgents

MarketingAgents is a founder-first marketing operating system built on Pi. This guide is for humans and agents contributing code, prompts, skills, docs, installers, or workflow behavior to the repository.

## Quick Links

- GitHub: https://github.com/youmake-ai/marketingagents
- Docs: https://github.com/youmake-ai/marketingagents/tree/main/website/src/content/docs
- Repo agent contract: [AGENTS.md](AGENTS.md)
- Issues: https://github.com/youmake-ai/marketingagents/issues
...
- Bundled Pi subagent prompts: `.marketingagents/agents/`
- Docs site: `website/`
- Build/release scripts: `scripts/`
- Generated marketing artifacts: `outputs/`, `notes/`

If you need to change how bundled subagents behave, edit `.marketingagents/agents/*.md`. Do not duplicate that behavior in `AGENTS.md`.
...
- Long-running marketing flows should write plan artifacts to `outputs/.plans/` and use `CHANGELOG.md` as a chronological campaign/workspace log when the work is substantial.
...
- context, diagnosis, strategy, and learning-loop quality
