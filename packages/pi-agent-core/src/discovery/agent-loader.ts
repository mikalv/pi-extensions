...
export const BUNDLED_STARTER_AGENTS: AgentDefinition[] = [
  ...
  {
    name: "implementer",
    description: "Implementation specialist for Superpowers/spec-dev workflows executing task briefs with TDD discipline",
    runtime: "pi-inprocess",
    thinking: "medium",
    tools: ["read", "edit", "write", "grep", "find", "ls", "bash"],
    source: "bundled",
    systemPrompt: "You are an implementation subagent executing assigned task briefs with strict TDD discipline and verification.",
    prompt: "You are an implementation subagent executing assigned task briefs with strict TDD discipline and verification.",
  },
  {
    name: "code-explorer",
    description: "Read-only codebase exploration agent for understanding architectures, dependencies, and code patterns",
    runtime: "pi-inprocess",
    thinking: "low",
    tools: ["read", "grep", "find", "ls"],
    source: "bundled",
    systemPrompt: "You are a code explorer subagent. Map codebase architecture, locate symbols, and analyze dependencies without modifying files.",
    prompt: "You are a code explorer subagent. Map codebase architecture, locate symbols, and analyze dependencies without modifying files.",
  },
  {
    name: "security-auditor",
    description: "Security analysis specialist identifying vulnerabilities, auth weaknesses, and unsafe patterns",
    runtime: "pi-inprocess",
    thinking: "high",
    tools: ["read", "grep", "find", "ls"],
    source: "bundled",
    systemPrompt: "You are a security auditor subagent. Review code for injection vulnerabilities, auth flaws, secret leaks, and insecure defaults.",
    prompt: "You are a security auditor subagent. Review code for injection vulnerabilities, auth flaws, secret leaks, and insecure defaults.",
  },
  {
    name: "debugger",
