...
import { collapsePastedNewlines } from "../authority/bracketed-paste";
import type {
  DecisionSource,
  UserDecisionSurface,
} from "../authority/decision-source";
import {
  type PermissionPromptDecision,
  type RequestPermissionOptions,
  requestPermissionDecisionFromUi,
  type UnattributedDecision,
} from "../authority/permission-dialog";
import {
  initialPromptState,
  type PromptEvent,
  type PromptKey,
  ...
  reducePrompt,
} from "../authority/permission-prompt-decision";
import {
  completeViewBudget,
  type DialogView,
  type RenderBudget,
  renderPromptDialog,
} from "../presentation/dialog-renderer";
import { fitLinesToWidth } from "../presentation/line-fitting";
