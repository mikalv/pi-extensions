...
} from "../../__generated__/agent/v1/background_shell_exec_pb.ts";
import type {
  ComputerUseArgs,
  ComputerUseResult,
...
import type {
  DeleteArgs,
  DeleteResult,
} from "../../__generated__/agent/v1/delete_exec_pb.ts";
import type {
  DiagnosticsArgs,
  DiagnosticsResult,
...
import type {
  ...
  ExecuteHookArgs,
  ExecuteHookResult,
} from "../../__generated__/agent/v1/exec_pb.ts";
import type {
  FetchArgs,
  FetchResult,
...
import type {
  GrepArgs,
  GrepResult,
} from "../../__generated__/agent/v1/grep_exec_pb.ts";
import type { LsArgs, LsResult } from "../../__generated__/agent/v1/ls_exec_pb.ts";
import type {
...
import type {
  ReadArgs,
  ReadResult,
} from "../../__generated__/agent/v1/read_exec_pb.ts";
import type {
  RecordScreenArgs,
  RecordScreenResult,
...
} from "../../__generated__/agent/v1/request_context_exec_pb.ts";
import type {
  ShellArgs,
  ShellResult,
  ShellStream,
} from "../../__generated__/agent/v1/shell_exec_pb.ts";
import type {
  WriteArgs,
  WriteResult,
} from "../../__generated__/agent/v1/write_exec_pb.ts";
import type {
  WriteShellStdinArgs,
...
import type { SimpleControlledExecManager } from "./simple-controlled-exec-manager.ts";
