...
import {
  ...
  type ModelDetails,
  ResumeAction,
} from "../../__generated__/agent/v1/agent_pb.ts";
import {
  ExecClientControlMessage,
  ExecClientMessage,
} from "../../__generated__/agent/v1/exec_pb.ts";
import type { KvClientMessage } from "../../__generated__/agent/v1/kv_pb.ts";
import type { McpTools } from "../../__generated__/agent/v1/mcp_pb.ts";
import type { ResourceAccessor } from "../agent-exec/registry-resource-accessor.ts";
import { SimpleControlledExecManager } from "../agent-exec/simple-controlled-exec-manager.ts";
import { type BlobStore, ControlledKvManager } from "../agent-kv/index.ts";
import { MapWritable } from "../utils/index.ts";
import {
  CheckpointController,
  type CheckpointHandler,
} from "./checkpoint-controller.ts";
import { ClientExecController, LostConnection } from "./exec-controller.ts";
import {
