...
import { AgentService as AgentServiceDef } from "../__generated__/agent/v1/agent_service_connect.ts";
import type { AgentRpcClient } from "../vendor/agent-client/index.ts";
