import type { BackgroundShellSpawnArgs } from "../../../__generated__/agent/v1/background_shell_exec_pb.ts";
import { BackgroundShellSpawnResult } from "../../../__generated__/agent/v1/background_shell_exec_pb.ts";
import type { ComputerUseArgs } from "../../../__generated__/agent/v1/computer_use_tool_pb.ts";
import {
  ComputerUseError,
  ComputerUseResult,
} from "../../../__generated__/agent/v1/computer_use_tool_pb.ts";
import type { DiagnosticsArgs } from "../../../__generated__/agent/v1/diagnostics_exec_pb.ts";
import {
  DiagnosticsResult,
  DiagnosticsSuccess,
} from "../../../__generated__/agent/v1/diagnostics_exec_pb.ts";
import type { FetchArgs } from "../../../__generated__/agent/v1/fetch_tool_pb.ts";
import {
  FetchError,
  FetchResult,
} from "../../../__generated__/agent/v1/fetch_tool_pb.ts";
import type {
  ListMcpResourcesExecArgs,
  ReadMcpResourceExecArgs,
} from "../../../__generated__/agent/v1/mcp_resource_tool_pb.ts";
import {
...
import type { McpArgs } from "../../../__generated__/agent/v1/mcp_tool_pb.ts";
import {
  McpError,
  McpResult,
} from "../../../__generated__/agent/v1/mcp_tool_pb.ts";
import type { RecordScreenArgs } from "../../../__generated__/agent/v1/record_screen_tool_pb.ts";
import {
  RecordScreenFailure,
  RecordScreenResult,
} from "../../../__generated__/agent/v1/record_screen_tool_pb.ts";
import { ShellRejected } from "../../../__generated__/agent/v1/shell_exec_pb.ts";
import type { WriteShellStdinArgs } from "../../../__generated__/agent/v1/write_shell_stdin_tool_pb.ts";
import {
  WriteShellStdinError,
  WriteShellStdinResult,
} from "../../../__generated__/agent/v1/write_shell_stdin_tool_pb.ts";
import type { Executor } from "../../../vendor/agent-exec/index.ts";
