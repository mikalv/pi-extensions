...
import type {
  LsArgs,
  LsResult,
} from "../../../__generated__/agent/v1/ls_exec_pb.ts";
import {
  LsError,
...
} from "../../../__generated__/agent/v1/selected_context_pb.ts";
import type { Executor } from "../../../vendor/agent-exec/index.ts";
import { resolvePath } from "../../../vendor/local-exec/index.ts";
import {
  toolResultToText,
...
import {
  decodeToolCallId,
  type PiToolContext,
} from "../local-resource-provider/types.ts";
import { requestToolExecution, shellQuote } from "../tool-bridge.ts";
