...
import { GitRepoInfo } from "../../../__generated__/agent/v1/repo_pb.ts";
import type { RequestContextArgs } from "../../../__generated__/agent/v1/request_context_exec_pb.ts";
import {
  RequestContext,
  RequestContextEnv,
  RequestContextError,
...
import {
  ...
  getGitStatus,
  LocalGitExecutor,
} from "../../../vendor/local-exec/index.ts";
