...
export function memoryStartupGuidance(): string {
	return [
		...
		"",
		"**Always recall first** before answering questions about: past decisions, user preferences, project architecture, previous bugs/fixes, recurring patterns, or anything the user has mentioned before.",
